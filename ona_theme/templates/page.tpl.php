...
<div class="layout-centered page-wrapper">
  <header class="header" role="banner">
    <a href="<?php print $front_page; ?>" title="<?php print t('Australian Government - Office of National Assessments - ONA'); ?>" rel="home" class="header__logo" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Australian Government - Office of National Assessments - ONA'); ?>" class="header__logo-image" /></a>
