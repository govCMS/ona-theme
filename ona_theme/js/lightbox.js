(function ($) {
    ...
    Drupal.behaviors.onaTheme = {
        attach: function (context, settings) {

            if (Drupal.settings.myTheme.themePath) {
                var themePath = Drupal.settings.myTheme.themePath;
                loadingImage = '/' + themePath + '/images/loading.gif';
                closeButton = '/' + themePath + '/images/close.gif';
            }

            if (Drupal.settings.myTheme) {
